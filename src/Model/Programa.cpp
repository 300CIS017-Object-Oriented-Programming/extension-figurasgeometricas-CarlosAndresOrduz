...
void Programa::inicializarFiguras(){
    ...
    vectorFiguras.push_back(new TrianguloEquilatero(10,15));
}
...
void Programa::agregarFigura(float lado, float altura) {
    vectorFiguras.push_back(new TrianguloEquilatero(lado,altura));
}
